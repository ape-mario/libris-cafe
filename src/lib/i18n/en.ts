export default {
  ...
  'pos.quantity': 'Qty',
  'pos.not_in_inventory': 'Book not in inventory',
  ...
  'inventory.adjust_prompt': 'Enter quantity (+/- number)',
  'inventory.adjust_placeholder': 'e.g. +5 or -2',
  ...
  'supplier.unknown': 'Unknown Supplier',
  ...
  'po.select_supplier': 'Select supplier...',
  'po.fill_titles': 'Please fill all item titles',
  'po.created': 'Purchase order created',
  'po.create_failed': 'Failed to create PO',
  'po.remove_item': 'Remove',
  'po.mark_ordered_confirm': 'This will mark the PO as sent to supplier.',
  'po.marked_ordered': 'PO marked as ordered',
  'po.update_failed': 'Failed to update PO',
  'po.received_success': 'Goods received and stock updated',
  'po.receive_failed': 'Failed to receive goods',
  'po.cancel_confirm': 'Cancel this purchase order?',
  'po.cancelled': 'PO cancelled',
  'po.cancel_failed': 'Failed to cancel PO',
  'po.not_found': 'Purchase order not found',
  ...
  'consignment.not_found': 'Consignor not found',
  'consignment.sales_load_failed': 'Failed to load sales data',
  'consignment.no_sales_period': 'No sales in this period',
  'consignment.settlement_created': 'Settlement created',
  'consignment.create_failed': 'Failed to create settlement',
  'consignment.confirm_message': 'Confirm this settlement?',
  'consignment.settlement_confirmed': 'Settlement confirmed',
  'consignment.confirm_failed': 'Failed to confirm settlement',
  'consignment.mark_paid_confirm': 'Mark this settlement as paid?',
  'consignment.settlement_paid': 'Settlement marked as paid',
  'consignment.pay_failed': 'Failed to mark as paid',
